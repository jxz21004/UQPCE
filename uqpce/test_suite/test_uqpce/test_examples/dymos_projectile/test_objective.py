...
class TestCost(unittest.TestCase):
    def setUp(self):
        ...
        prob.set_val('obj_comp.mean', 140.0)
        prob.set_val('obj_comp.variance', 62.35886459)
    ...
    def test_partials(self):
        partial_mu = self.partials['obj_comp'][('obj', 'mean')]['rel error'][0]
    ...
    def test_compute(self):
        calc = (150 - self.prob.get_val('mean')) ** 2
